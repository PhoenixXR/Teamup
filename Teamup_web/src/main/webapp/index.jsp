...
<h1 class="page-title" style="color: #666666;
    ...
    <!-- 按钮调用 JavaScript 函数 -->
    <button id="refreshButton" onclick="window.location.href='http://121.40.96.127:8080/Teamup_web_war_exploded/listv'"
    style="font-size: 16px;text-align: center;position: absolute;left: 25%;
...
<%--自动刷新--%>
<%--<meta http-equiv="refresh" content="3; url=http://192.168.0.115/Teamup_web_war_exploded/listv">--%>
<%--<meta http-equiv="refresh" content="3; url=http://121.40.96.127:8080/Teamup_web_war_exploded/listv">--%>

<%--提交表单--%>
<%--<form action="http://192.168.0.115/Teamup_web_war_exploded/listv" method="POST">--%>
<%--    <label for="inputString"></label>--%>
<%--    <input type="text" id="inputString" name="index">--%>
<%--    <br>--%>
