...
public class PlService {
    public static boolean Pub(String kook, String lv,String num) {
        //MyThread2 myThread2 = new MyThread2("http://192.168.0.119/Teamup_web_war_exploded/Pub",kook,lv,num);
    ...
    public static Stack listv() throws MalformedURLException {
        //URL url = new URL("http://192.168.0.119/Teamup_web_war_exploded/listv");
