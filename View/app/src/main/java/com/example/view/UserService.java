...
public class UserService {
    public static boolean signIn(String name, String password) {
        //MyThread myThread = new MyThread("http://192.168.0.115/Teamup_web_war_exploded/SignIn",name,password);
    ...
    public static boolean signUp(String name, String password) {
        //MyThread myThread = new MyThread("http://192.168.0.115/Teamup_web_war_exploded/SignUp",name,password);
